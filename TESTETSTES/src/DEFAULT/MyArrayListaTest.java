...
import Labb2.MyArrayLista;

public class MyArrayListaTest {

	private static MyArrayLista<Integer> data;
	...
	public static void testAvMyArrayLista() {
		System.out.println("Test av MyArrayLista() starts");
		try {
			data = new MyArrayLista<Integer>(-1);
		} catch (IllegalArgumentException e) {
			// fungerar; det ska bli IllegalArgumentException
		} catch (Exception e) {
			throw new RuntimeException("MyArrayLista 1: " + e);
		}

		data = new MyArrayLista<Integer>();
		int N = 10;
		try {
			insert(N);
			N = N * 100;
			...
			throw new RuntimeException("MyArrayLista 2, N==" + N);
		}
		System.out.println("Test av MyArrayLista() OK");
	}
	...
	public static void testAvAddindex() {
		...
		data = new MyArrayLista<Integer>(100);
		try {
			data.add(-1, null);
	...
	public static void testAvClone() {
		...
		data = new MyArrayLista<Integer>();
		insert(3);
		MyArrayLista<Integer> clone = (MyArrayLista<Integer>) data.clone();
